...
CAST(JSON_VALUE(data,'$.loan_application_draft_id') as INT64) AS loan_application_draft_id,
...
CAST(JSON_VALUE(data,'$.attributed_affiliate') as STRING) AS attributed_affiliate,
...
where table='loan_application_versions'
QUALIFY rn = 1
)
