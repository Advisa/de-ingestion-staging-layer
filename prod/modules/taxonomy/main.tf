...
resource "google_storage_bucket_object" "taxonomy_csv_file" {
  ...
  source = "/Users/aruldharani/Sambla/de-ingestion-staging-layer/prod/policy_tags_service/csv_exporter/outputs/taxonomy.csv" # Replace with your local CSV file path
...
resource "google_storage_bucket_object" "policy_tags_csv_file" {
  ...
  bucket = google_storage_bucket.taxonomy_bucket.name
  source = "/Users/aruldharani/Sambla/de-ingestion-staging-layer/prod/policy_tags_service/csv_exporter/outputs/policy_tags.csv" # Replace with your local CSV file path
  depends_on = [ google_storage_bucket.taxonomy_bucket ]
}
...
resource "google_bigquery_table" "taxonomy_bq_table" {
  ...
  external_data_configuration {
    ...
    schema = file("/Users/aruldharani/Sambla/de-ingestion-staging-layer/prod/schemas/taxonomy/taxonomy_schema.json")
...
resource "google_bigquery_table" "policy_tags_bq_table" {
  ...
  external_data_configuration {
    ...
    # must to define a schema when we create a table
    schema = file("/Users/aruldharani/Sambla/de-ingestion-staging-layer/prod/schemas/taxonomy/policy_tags_schema.json")
