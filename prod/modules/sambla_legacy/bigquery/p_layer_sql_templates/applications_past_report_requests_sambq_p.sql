...
source as (
    SELECT
      creditReports.* except (pastReportRequests),
      pastReportRequests.name as past_report_requests_name,
      pastReportRequests.date  as past_report_requests_date,
      pastReportRequests._id  as past_report_requests_id
    FROM
      creditReports,
      UNNEST(creditReports.pastReportRequests) AS pastReportRequests
      )
