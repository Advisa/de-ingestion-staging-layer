...
class Main:
    def __init__(self):
        ...
        self.config_file = os.path.join(current_dir, "output_files/column_lineage.yml")
        self.input_csv = os.path.join(current_dir, "data/sensitive_field_mapping.csv")  # [TODO] retrieve from bucket or googlesheet in the future
        self.output_json = os.path.join(parent_dir, "schemas/policy_tags/resolved_columns.json") 
